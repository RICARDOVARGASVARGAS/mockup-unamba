/**
 * admin-login.js — interacción del login del panel administrativo.
 *
 * Sin backend: el submit no valida nada, solo navega a dashboard.html
 * para que la demo se sienta como un flujo real. La alerta de error
 * (`[data-login-error]`) queda en el markup para mostrar el estado
 * visual, pero no se activa desde aquí.
 */
