/**
 * admin-topbar.js — barra superior del panel administrativo
 * (<admin-topbar>). Título vía atributo page-title.
 *
 * Usuario de ejemplo fijo (sin sesión real — el mockup no tiene
 * backend): un solo rol, Administrador (ver docentrack/CLAUDE.md).
 *
 * Todo el archivo va dentro de un IIFE, mismo motivo que admin-sidebar.js.
 */
(function () {
  const ICONS = {
