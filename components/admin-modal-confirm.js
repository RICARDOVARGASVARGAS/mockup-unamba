 ...
 * Al confirmar, quita el [data-row] más cercano al trigger (con
 * transición) y dispara "admin:toast" para avisar que se eliminó. Sin
 * backend: el cambio es solo en el DOM, se resetea al recargar la
 * página. [data-row] en vez de "tr": funciona igual si el listado es
 * una <table> (Noticias, Eventos, Comunicados, Banners) o un grid de
 * <div> (Galería).
 */
(function () {
  const ICONS = {
